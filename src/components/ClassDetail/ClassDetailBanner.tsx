...
const ClassDetailBanner: React.FC<ClassBannerProps> = ({
  ...
  return (
    <div className=" mx-auto relative mt-3">
      <div className="relative rounded-md object-center h-full min-h-[400px]">
        <div className="w-full h-full min-h-[400px] rounded-md">
          <img
      ...
      <div className="absolute bottom-0 left-0 right- w-full flex items-end justify-between h-24 px-5 pb-5">
