  ...
  return <div className='sm:w-1/2 sm:mx-auto  md:w-2/4 mdLg:w-1/2 lg:w-2/5 mx-5 min-w-max'>
    <Formik initialValues={{
      ...
      <Form className='font-medium text-lg flex flex-col gap-5 w-full items-center'>
        ...
        <div className='w-full'>
          <label htmlFor='email' >{t('lastName.label')}</label>
          <Field name='email' type='email' placeholder={t('lastName.label')} className='w-full px-3 py-2 border ring-1 border-gray-500 rounded-md focus:outline-none focus:ring-green-300 transition-all'/>
          <div className='w-full text-base text-red-500 font-semibold'>
