...
function SignUpPage() {
  ...
  return <>
    ...
    validationSchema={Yup.object({
      ...
      email: Yup.string()
        .email(t('signUpPage.email.invalid'))
      ...
      confirmPassword: Yup.string()
        .oneOf([Yup.ref('password'), ''], t('signUpPage.confirmPassword.match'))
    ...
    onSubmit={(values)=>{
      ...
      <Form className="form" autoComplete='off'>
        ...
        <div className='AcceptTerms'>
          <label htmlFor="acceptTerms">{t('signUpPage.acceptTerms.label')}</label>
