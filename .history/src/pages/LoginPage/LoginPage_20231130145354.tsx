...
function LoginPage() {
  ...
  return <div className='md:w-1/2 lg:w-2/5 bg-gray-400'>
    <Formik initialValues={{ email: '', password: '' }}
      ...
      <Form>
        <div className='font-medium text-xl'>
          <div className='flex'>
            <label htmlFor="email" className='inline-block w-2/5'>{t('LoginPage.email.label')}</label>
        ...
        <div className='font-medium text-xl'>
          <div className='flex'>
            <label htmlFor="password" className='inline-block w-2/5'>{t('LoginPage.password.label')}</label>
