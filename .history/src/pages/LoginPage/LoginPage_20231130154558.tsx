...
function LoginPage() {
  ...
  return <div className='sm:w-1/2 sm:mx-auto md:w-3/4 lg:w-2/6 mx-5'>
    <h1 className='text-4xl font-semibold text-center py-10'>Welcome</h1>
    {/* sign in with google */}
    <div className='flex rounded-md justify-stretch border border-blue-500 mb-5 max-w-fit'>
      {/* icon */}
      <div className='bg-white rounded-l-md w-12 items-center justify-center flex'>
        <FcGoogle className='w-6 h-6'/>
      </div>
      {/* text */}
      <div className='text-lg text-white font-semibold px-3 py-2 bg-blue-500 w-full text-center rounded-r-md'>{t('LoginPage.Google.label')}</div>
    </div>
