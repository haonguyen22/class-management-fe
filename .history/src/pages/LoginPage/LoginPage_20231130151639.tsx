...
function LoginPage() {
  ...
  return <div className='md:w-1/2 lg:w-2/6 bg-gray-400 mx-auto'>
    ...
    <div className='flex flex-col gap-5 w-full items-center'>
      <button className='px-3 py-2 w-full bg-blue-500 rounded-md text-white'>{t('LoginPage.google.label')}</button>
      <button className='px-3 py-2 w-full bg-blue-500 rounded-md text-white'>{t('LoginPage.facebook.label')}</button>
    </div>
