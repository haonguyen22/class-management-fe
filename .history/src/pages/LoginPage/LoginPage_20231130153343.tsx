...
function LoginPage() {
  ...
  return <div className='md:w-1/2 lg:w-2/6 bg-gray-400 mx-auto'>
    ...
    {/* sign in with google */}
    <div className='flex rounded-md items-center border border-blue-500'>
      {/* icon */}
      <div className='bg-white h-full rounded-l-md flex-shrink-0'>
        <FcGoogle className='w-6 h-full'/>
      </div>
      {/* text */}
