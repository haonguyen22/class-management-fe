...
function LoginPage() {
  ...
  return <div className='md:w-1/2 lg:w-2/6 bg-gray-400 mx-auto'>
    ...
    {/* sign in with google */}
    <div className='flex rounded-md items-center w-full'>
      {/* icon */}
      <FcGoogle className='bg-white'/>
      {/* text */}
      <div className='text-lg font-semibold px-3 py-2 bg-blue-500 w-full text-center'>{t('LoginPage.Google.label')}</div>
    </div>
