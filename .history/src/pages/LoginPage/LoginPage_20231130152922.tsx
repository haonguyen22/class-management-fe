...
function LoginPage() {
  ...
  return <div className='md:w-1/2 lg:w-2/6 bg-gray-400 mx-auto'>
    ...
    {/* sign in with google */}
    <div className='flex rounded-md items-center justify-stretch px-3 py-2'>
      {/* icon */}
      <FcGoogle className='bg-white h-9 w-9'/>
      {/* text */}
      <div className='text-lg font-semibold  bg-blue-500 w-full h-full text-center rounded-r-md'>{t('LoginPage.Google.label')}</div>
    </div>
