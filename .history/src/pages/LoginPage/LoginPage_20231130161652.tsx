...
function LoginPage() {
  ...
  return <div className='sm:w-1/2 sm:mx-auto md:w-3/4 lg:w-2/6 mx-5 min-w-max'>
    ...
    {/* sign in with google */}
    <div className='flex rounded-md justify-stretch border border-green-500 mb-5 min-w-fit'>
      <div className='bg-white rounded-l-md w-12 items-center justify-center flex'>
        <FcGoogle className='w-6 h-6'/>
      </div>
      <div className='text-lg text-white font-semibold px-3 py-2 bg-green-500 w-full text-center rounded-r-md min-w-fit'>{t('LoginPage.Google.label')}</div>
    </div>
