...
function LoginPage() {
  ...
  return <div className='sm:w-1/2 sm:mx-auto md:w-3/4 lg:w-2/6 mx-5 min-w-max'>
    ...
    <div className='flex items-center mb-4'>
      <hr className='flex-grow border border-gray-500 h-5'/>
    ...
    <Formik initialValues={{ email: '', password: '' }}
      ...
      <Form className='font-medium text-lg flex flex-col gap-5 w-full items-center'>
        <div className='w-full'>
          ...
          <Field name='email' type='email' placeholder={t('LoginPage.email.label')} className='w-full px-3 py-2 border ring-1 border-gray-500 rounded-md'/>
