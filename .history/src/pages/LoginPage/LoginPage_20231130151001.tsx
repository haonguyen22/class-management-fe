      ...
      <Form className='font-medium text-lg flex flex-col gap-5 w-full items-center'>
        <div className='w-full'>
          <div className='flex items-center'>
            ...
            <Field name="email" type="email" className='w-full px-3 py-2 border border-gray-500'/>
          </div>
        ...
        <div className='w-full'>
          <div className='flex'>
            ...
            <Field name="password" type="password" className='w-full px-3 py-2 border border-gray-500'/>
          </div>
          <div className='w-full text-base text-red-500 font-semibold'>
